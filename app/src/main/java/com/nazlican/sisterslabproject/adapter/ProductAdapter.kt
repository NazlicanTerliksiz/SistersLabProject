...
class ProductAdapter(private val productList: List<ProductX>, private val onItemClickListener: (Int) -> Unit) :
    RecyclerView.Adapter<ProductAdapter.RowHolder>() {

    inner class RowHolder(private val binding: ProductCardDesignBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RowHolder {
        val binding = ProductCardDesignBinding.inflate(LayoutInflater.from(parent.context), parent, false)
